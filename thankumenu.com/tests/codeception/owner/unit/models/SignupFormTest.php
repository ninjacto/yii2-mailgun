...
namespace tests\codeception\owner\unit\models;

use tests\codeception\owner\unit\DbTestCase;
    ...
    public function fixtures()
    {
        return [
            'user' => [
                ...
                'dataFile' => '@tests/codeception/owner/unit/fixtures/data/models/user.php',
            ],
        ];
    }
}
