...
$replacements = [
    'ninjacto\\\\yii2-mailgun\\\\' => function () use(&$values) { return str_replace('\\', '\\\\', $values['psr4_namespace']) . '\\\\'; },
    'Ramin Farmani'                 => function () use(&$values) { return $values['author_name']; },
    ':author_username'             => function () use(&$values) { return $values['author_github_username']; },
    'http://www.ninjacto.com'              => function () use(&$values) { return $values['author_website'] ?: ('https://github.com/' . $values['author_github_username']); },
    'ramin.farmani@gmail.com'                => function () use(&$values) { return $values['author_email'] ?: ($values['author_github_username'] . '@example.com'); },
    'ninjacto'                      => function () use(&$values) { return $values['package_vendor']; },
    'yii2-mailgun'                => function () use(&$values) { return $values['package_name']; },
    'Mailgun mailer component for Yii 2 framework'         => function () use(&$values) { return $values['package_description']; },
